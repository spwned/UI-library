...
do
    ...
    function Funcs:AddColorPicker(Idx, Info)
        ...
        Library:AddToRegistry(RgbBoxBase.Frame or RgbBoxBase, { BackgroundColor3 = 'MainColor'; BorderColor3 = 'OutlineColor'; });
...
-- ============================================================
-- WINDOW SETUP - runs immediately after library loads
-- ============================================================
...
local Left  = Tab:AddLeftGroupbox('General')
local Right = Tab:AddRightGroupbox('Info')

Left:AddToggle('TestToggle', {
    Text    = 'Example Toggle',
    Default = false,
...
Right:AddLabel('Toggle menu: Right Ctrl or Right Shift', true)
Right:AddDivider()
Right:AddLabel('If you can see this, the UI is working!', true)

Library:SetWatermark('My Menu  |  ' .. game.Players.LocalPlayer.Name)
